...
/** @file djlsutil.h
 *  @brief enumerations, error constants and helper functions for the dcmjpls
 * module
 */
...
/// in this bit depth
extern FMJPEG2K_EXPORT const OFConditionConst
...
/// error condition constant: Cannot compute number of fragments for JPEG-LS
/// frame
extern FMJPEG2K_EXPORT const OFConditionConst
