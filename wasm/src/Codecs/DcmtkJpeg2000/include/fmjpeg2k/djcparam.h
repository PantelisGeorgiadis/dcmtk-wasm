...
class FMJPEG2K_EXPORT DJPEG2KCodecParameter : public DcmCodecParameter {
 public:
   ...
   *  @param jp2k_optionsEnabled       enable/disable use of all JPEG-2000
   * parameters
  ...
  DJPEG2KCodecParameter(
      OFBool jp2k_optionsEnabled, Uint16 jp2k_cblkwidth = 64,
      Uint16 jp2k_cblkheight = 64, OFBool preferCookedEncoding = OFTrue,
      Uint32 fragmentSize = 0, OFBool createOffsetTable = OFTrue,
  ...
  /// copy constructor
  DJPEG2KCodecParameter(DJPEG2KCodecParameter const &arg);
 ...
 private:
  ...
  DJPEG2KCodecParameter &operator=(DJPEG2KCodecParameter const &);
