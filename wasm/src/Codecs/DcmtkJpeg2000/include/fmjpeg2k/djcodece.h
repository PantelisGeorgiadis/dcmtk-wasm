...
class FMJPEG2K_EXPORT DJPEG2KEncoderBase : public DcmCodec {
 ...
 private:
   ...
   *  @return EC_Normal if successful, an error code otherwise.
   */
  OFCondition losslessRawEncode(Uint16 const *pixelData, const Uint32 length,
                                DcmItem *dataset,
                                FMJPEG2KRepresentationParameter const *djrp,
                                DcmPixelSequence *&pixSeq,
                                DJPEG2KCodecParameter const *djcp,
   ...
   *  @return EC_Normal if successful, an error code otherwise.
   */
  OFCondition RenderedEncode(Uint16 const *pixelData, const Uint32 length,
                             DcmItem *dataset,
                             FMJPEG2KRepresentationParameter const *djrp,
                             DcmPixelSequence *&pixSeq,
                             DJPEG2KCodecParameter const *djcp,
  ...
  OFCondition updateDerivationDescription(
      DcmItem *dataset, FMJPEG2KRepresentationParameter const *djrp,
      double ratio) const;
  ...
  OFCondition compressRawFrame(
      ...
      unsigned long &compressedSize, DJPEG2KCodecParameter const *djcp) const;
  ...
  OFCondition compressRenderedFrame(
      ...
      unsigned long &compressedSize, DJPEG2KCodecParameter const *djcp,
      Uint32 frame, FMJPEG2KRepresentationParameter const *djrp) const;
   ...
   *  @return EC_Normal if succesful, an error code otherwise
   */
  OFCondition convertToSampleInterleaved(Uint8 *target, Uint8 const *source,
                                         Uint16 components, Uint32 width,
                                         Uint32 height,
