...
/** singleton class that registers encoders for all supported JPEG 2000
 * processes.
 */
class FMJPEG2K_EXPORT FMJPEG2KEncoderRegistration {
 public:
   ...
   *  @param jp2k_optionsEnabled       enable/disable use of all five JPEG 2000
   * parameters
   *  @param jp2k_cblkwidth            JPEG-2000 parameter "Threshold 1" (used
   * for quantization)
   ...
   * JPEG-LS datastream should use
   */
  static void registerCodecs(OFBool jp2k_optionsEnabled = OFFalse,
